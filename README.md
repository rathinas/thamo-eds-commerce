...
## Environments
- Preview: https://main--thamo-eds-commerce--rathinas.aem.page/
- Live: https://main--thamo-eds-commerce--rathinas.aem.live/
...
1. Open the `thamo-eds-commerce` directory in your favorite IDE and start coding :)
